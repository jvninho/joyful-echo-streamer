            ...
            >
              ...
              <div className="text-center">
                <Button 
                  ...
                  className="bg-akatsuki hover:bg-akatsuki-dark text-white font-bold py-3 px-8 rounded-lg text-lg transition-colors min-w-[200px]"
                >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="flex justify-center space-x-4 mt-2">
                <a href="#" className="text-gray-600 hover:text-akatsuki">
